...
class MyFrame extends JFrame implements ActionListener, MouseListener{
	...
	public MyFrame(){
        ...
        background.setBounds(0,0,1500,550);
        p.add(background);
		p.setVisible(true);
		...
		JLabel l1,l2,l3;
		l1 = new JLabel("USING DIJAKSTRA'S ALGORITHM: ");
		l2 = new JLabel("Enter Source: ");
		l3 = new JLabel("Enter Destination: ");
		l1.setBounds(getWidth()/2,10,250,15);
		l2.setBounds(20,30,100,10);
		l3.setBounds(270,30,150,10);
		t1 = new TextField(10);
		t2 = new TextField(10);
		...
		p1.add(b);
		l4 = new JLabel("ADDITION OF EDGES VALUE");
		l5 = new JLabel("From:");
		l6 = new JLabel("To:");
		...
		t4 = new TextField(10);
		t5 = new TextField(10);
		l4.setBounds(1000,25,200,15);
		l5.setBounds(850,45,50,20);
		t3.setBounds(900,45,70,20);
		l6.setBounds(1000,45,20,20);
		t4.setBounds(1030,45,70,20);
		l7.setBounds(1140,45,50,20);
		t5.setBounds(1200,45,70,20);
		p1.add(l4);
		p1.add(l5);
		p1.add(t3);
		p1.add(l6);
